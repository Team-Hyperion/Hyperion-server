...
namespace hyperion::core
{
    ...
    TEST_F(FileSystemTest, WorkingDirectoryGetSet) {
        ...
        EXPECT_EQ(hyperion::core::GetExecutingDirectory(), "C:/x/y/z");
#endif

        SetExecutingDirectory("abcdefghijkl;'");
        EXPECT_EQ(hyperion::core::GetExecutingDirectory(), "");

        SetExecutingDirectory("x/y/z/b.exe");
        EXPECT_EQ(hyperion::core::GetExecutingDirectory(), "x/y/z");

        SetExecutingDirectory("x/123456.exe");
        EXPECT_EQ(hyperion::core::GetExecutingDirectory(), "x");
    }
    ...
    TEST_F(FileSystemTest, ResolvePath) {
        ...
        EXPECT_EQ(hyperion::core::ResolvePath(""), "antarctica/");

        EXPECT_EQ(hyperion::core::ResolvePath("glaciers/glacier1.png"), "antarctica/glaciers/glacier1.png");

        EXPECT_EQ(hyperion::core::ResolvePath("banana/banana1.png"), "antarctica/banana/banana1.png");
