...
#ifndef HYPERION_INCLUDE_CORE_EXECUTION_TIMER_H
#define HYPERION_INCLUDE_CORE_EXECUTION_TIMER_H
#pragma once
...
#define EXECUTION_PROFILE_SCOPE(timer_variable_name, item_name) \
    auto(timer_variable_name) = hyperion::core::ExecutionTimer(item_name)
...
#endif // HYPERION_INCLUDE_CORE_EXECUTION_TIMER_H
