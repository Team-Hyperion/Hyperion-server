...
void hyperion::core::OpenLogFile() {
    log_file.open(ResolvePath(kLogFileName));
}

void hyperion::core::CloseLogFile() {
    if (log_file.is_open())
        log_file.close();
}
...
void hyperion::core::LogMessage(const LogSeverity severity,
...
std::string hyperion::core::LogSeverityStr(const LogSeverity severity) {
...
std::string hyperion::core::LogSeverityStrColored(const LogSeverity severity) {
    std::string severity_str;
